data "azurerm_management_group" "pagamenti_servizi_cloud_prod" {
...
resource "azurerm_management_group_policy_exemption" "pagamenti_servizi_cloud_prod_iso_27001_2013_mitigated" {
  name                            = "${azurerm_management_group_policy_assignment.pagamenti_servizi_cloud_prod_iso_27001_2013.name}-mitigated"
  management_group_id             = data.azurerm_management_group.pagamenti_servizi_cloud_prod.id
  policy_assignment_id            = azurerm_management_group_policy_assignment.pagamenti_servizi_cloud_prod_iso_27001_2013.id
...
resource "azurerm_management_group_policy_exemption" "pagamenti_servizi_cloud_prod_iso_27001_2013_waiver" {
  name                            = "${azurerm_management_group_policy_assignment.pagamenti_servizi_cloud_prod_iso_27001_2013.name}-waiver"
  management_group_id             = data.azurerm_management_group.pagamenti_servizi_cloud_prod.id
  policy_assignment_id            = azurerm_management_group_policy_assignment.pagamenti_servizi_cloud_prod_iso_27001_2013.id
...
resource "azurerm_management_group_policy_exemption" "pagamenti_servizi_cloud_prod_azure_security_benchmark_waiver" {
  name                            = "${azurerm_management_group_policy_assignment.pagopa_azure_security_benchmark.name}${local.pagamenti_servizi_cloud_prod_prefix}-waiver"
  management_group_id             = data.azurerm_management_group.pagamenti_servizi_cloud_prod.id
...
resource "azurerm_role_assignment" "pagamenti_servizi_cloud_prod_resource_lock_contributor" {
  scope                = data.azurerm_management_group.pagamenti_servizi_cloud_prod.id
  role_definition_name = "PagoPA Resource Lock Contributor"
  principal_id         = azurerm_management_group_policy_assignment.pagamenti_servizi_cloud_prod_resource_lock.identity[0].principal_id
}
...
resource "azurerm_role_assignment" "pagamenti_servizi_cloud_prod_audit_logs_monitoring_contributor" {
  scope                = data.azurerm_management_group.pagamenti_servizi_cloud_prod.id
...
resource "azurerm_role_assignment" "pagamenti_servizi_cloud_prod_audit_logs_contributor_log_analytics" {
  scope                = data.terraform_remote_state.policy_set.outputs.audit_logs_workspace_id
  role_definition_name = "Log Analytics Contributor"
  principal_id         = azurerm_management_group_policy_assignment.pagamenti_servizi_cloud_prod_audit_logs.identity[0].principal_id
}

resource "azurerm_role_assignment" "pagamenti_servizi_cloud_prod_audit_logs_contributor_storage_westeurope" {
...
resource "azurerm_management_group_policy_assignment" "pagamenti_servizi_cloud_prod_event_hub" {
  name                 = "${local.pagamenti_servizi_cloud_prod_prefix}evt"
...
resource "azurerm_management_group_policy_assignment" "pagamenti_servizi_cloud_prod_kubernetes" {
  name                 = "${local.pagamenti_servizi_cloud_prod_prefix}k8s"
...
resource "azurerm_management_group_policy_assignment" "pagamenti_servizi_cloud_prod_app_service" {
  name                 = "${local.pagamenti_servizi_cloud_prod_prefix}appservice"
...
resource "azurerm_management_group_policy_assignment" "pagamenti_servizi_cloud_prod_redis" {
  name                 = "${local.pagamenti_servizi_cloud_prod_prefix}redis"
  display_name         = "PagoPA App Service"
...
resource "azurerm_management_group_policy_assignment" "pagamenti_servizi_cloud_prod_cosmosdb" {
  name                 = "${local.pagamenti_servizi_cloud_prod_prefix}cosmosdb"
