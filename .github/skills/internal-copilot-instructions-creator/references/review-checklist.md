...
- `.github/agents/local-sync-external-resources.agent.md` still reflects the managed imported instruction list after imported assets are replaced or retired.
