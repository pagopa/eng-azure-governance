...
resource "azurerm_management_group_policy_exemption" "pagamenti_servizi_cloud_dev_azure_security_benchmark_waiver" {
  name                 = "${azurerm_management_group_policy_assignment.pagopa_azure_security_benchmark.name}${local.pagamenti_servizi_cloud_dev_prefix}-waiver"
