locals {
  audit_logs = {
    keyvault_workspaceid = {
      reference_id = "keyvault_workspaceid"
    }
    keyvault_storageid_westeurope = {
      reference_id = "keyvault_storageid_westeurope"
    }
    ...
    application_gateway_storageid_westeurope = {
      reference_id = "application_gateway_storageid_westeurope"
    }
    ...
    container_registry_storageid_westeurope = {
      reference_id = "container_registry_storageid_westeurope"
    }
    ...
    kubernetes_cluster_storageid_westeurope = {
      reference_id = "kubernetes_cluster_storageid_westeurope"
    }
    ...
    api_management_storageid_westeurope = {
      reference_id = "api_management_storageid_westeurope"
    }
    ...
    postgresql_flexible_storageid_westeurope = {
      reference_id = "postgresql_flexible_storageid_westeurope"
    }
    ...
    postgresql_single_server_storageid_westeurope = {
      reference_id = "postgresql_single_server_storageid_westeurope"
    }
    ...
    log_analytics_storageid_westeurope = {
      reference_id = "log_analytics_server_storageid_westeurope"
    }
    ...
    cosmos_db_storageid_westeurope = {
      reference_id = "cosmos_db_storageid_westeurope"
    }
    ...
    app_service_storageid_westeurope = {
      reference_id = "app_service_storageid_westeurope"
    }
    ...
    event_hub_storageid_westeurope = {
      reference_id = "event_hub_storageid_westeurope"
    }
    ...
    public_ip_storageid_westeurope = {
      reference_id = "public_ip_storageid_westeurope"
    }
    ...
    virtual_network_gateway_storageid_westeurope = {
      reference_id = "virtual_network_gateway_storageid_westeurope"
    }
    ...
    grafana_storageid_westeurope = {
      reference_id = "grafana_storageid_westeurope"
    }
