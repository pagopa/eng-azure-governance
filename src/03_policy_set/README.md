...
| <a name="input_audit_logs_storage_regions"></a> [audit\_logs\_storage\_regions](#input\_audit\_logs\_storage\_regions) | n/a | `list(string)` | <pre>[<br>  "west_europe",<br>  "northeurope",<br>  "italynorth"<br>]</pre> | no |
