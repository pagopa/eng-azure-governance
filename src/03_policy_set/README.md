...
| [azurerm_policy_set_definition.postgresql_dev](https://registry.terraform.io/providers/hashicorp/azurerm/3.38.0/docs/resources/policy_set_definition) | resource |
...
| [azurerm_policy_set_definition.postgresql_uat](https://registry.terraform.io/providers/hashicorp/azurerm/3.38.0/docs/resources/policy_set_definition) | resource |
...
| <a name="input_postgresql_dev"></a> [postgresql\_dev](#input\_postgresql\_dev) | List of PostgreSQL policy set parameters | <pre>object({<br>    listofallowedskuname = list(string)<br>  })</pre> | <pre>{<br>  "listofallowedskuname": [<br>    "Standard_B2ms",<br>    "Standard_B4ms",<br>    "Standard_B8ms"<br>  ]<br>}</pre> | no |
| <a name="input_postgresql_prod"></a> [postgresql\_prod](#input\_postgresql\_prod) | List of PostgreSQL policy set parameters | <pre>object({<br>    listofallowedskuname = list(string)<br>  })</pre> | <pre>{<br>  "listofallowedskuname": [<br>    "Standard_B2ms",<br>    "Standard_B4ms",<br>    "Standard_B8ms"<br>  ]<br>}</pre> | no |
| <a name="input_postgresql_uat"></a> [postgresql\_uat](#input\_postgresql\_uat) | List of PostgreSQL policy set parameters | <pre>object({<br>    listofallowedskuname = list(string)<br>  })</pre> | <pre>{<br>  "listofallowedskuname": [<br>    "Standard_B2ms",<br>    "Standard_B4ms",<br>    "Standard_B8ms"<br>  ]<br>}</pre> | no |
