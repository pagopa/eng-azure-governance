...
resource "azurerm_management_group_policy_exemption" "security_itoperations_prod_azure_security_benchmark_waiver" {
  name                            = "${azurerm_management_group_policy_assignment.pagopa_azure_security_benchmark.name}${local.security_itoperations_prod_prefix}-waiver"
  management_group_id             = data.azurerm_management_group.security_itoperations_prod.id
...
resource "azurerm_management_group_policy_assignment" "security_itoperations_prod_event_hub" {
  name                 = "${local.security_itoperations_prod_prefix}evt"
...
resource "azurerm_management_group_policy_assignment" "security_itoperations_prod_kubernetes" {
  name                 = "${local.security_itoperations_prod_prefix}k8s"
