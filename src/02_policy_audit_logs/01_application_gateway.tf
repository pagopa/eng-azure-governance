resource "azurerm_policy_definition" "audit_logs_application_gateway_log_analytics" {
  ...
  policy_rule = templatefile("./policy_rules/application_gateway_log_analytics.json", {
...
resource "azurerm_policy_definition" "audit_logs_application_gateway_storage_account" {
  ...
  policy_rule = templatefile("./policy_rules/application_gateway_storage_account.json", {
    roleDefinitionIds_audit_logs_contributor    = data.azurerm_role_definition.audit_logs_contributor.id,
    roleDefinitionIds_log_analytics_contributor = data.azurerm_role_definition.log_analytics_contributor.id,
  })
