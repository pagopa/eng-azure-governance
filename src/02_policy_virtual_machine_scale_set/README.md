# Azure Policy: Virtual Machine Scale Sets

This Terraform root defines the custom Azure Policy control for allowed virtual-machine scale-set SKUs.

## Purpose

Use this directory for the virtual-machine scale-set policy definition and its policy-rule parameter files. The root resolves the `pagopa` management group and exposes the policy ID shown in the generated Terraform reference below.
...
| Name | Type |
|------|------|
| [azurerm_policy_definition.virtual_machine_scale_set_allowed_sku](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/policy_definition) | resource |
