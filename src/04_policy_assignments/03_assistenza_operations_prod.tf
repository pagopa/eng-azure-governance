data "azurerm_management_group" "assistenza_operations_prod" {
  name = "assistenza_operations_prod"
}

locals {
  assistenza_operations_prod_prefix = "aop"
}

resource "azurerm_management_group_policy_assignment" "assistenza_operations_prod_iso_27001_2013" {
  name                 = "${local.assistenza_operations_prod_prefix}iso270012013"
...
resource "azurerm_management_group_policy_exemption" "assistenza_operations_prod_iso_27001_2013_mitigated" {
  name                            = "${azurerm_management_group_policy_assignment.assistenza_operations_prod_iso_27001_2013.name}-mitigated"
  management_group_id             = data.azurerm_management_group.assistenza_operations_prod.id
  policy_assignment_id            = azurerm_management_group_policy_assignment.assistenza_operations_prod_iso_27001_2013.id
...
resource "azurerm_management_group_policy_exemption" "assistenza_operations_prod_iso_27001_2013_waiver" {
  name                            = "${azurerm_management_group_policy_assignment.assistenza_operations_prod_iso_27001_2013.name}-waiver"
  management_group_id             = data.azurerm_management_group.assistenza_operations_prod.id
  policy_assignment_id            = azurerm_management_group_policy_assignment.assistenza_operations_prod_iso_27001_2013.id
...
resource "azurerm_management_group_policy_exemption" "assistenza_operations_prod_azure_security_benchmark_waiver" {
  name                            = "${azurerm_management_group_policy_assignment.pagopa_azure_security_benchmark.name}${local.assistenza_operations_prod_prefix}-waiver"
  management_group_id             = data.azurerm_management_group.assistenza_operations_prod.id
...
resource "azurerm_management_group_policy_assignment" "assistenza_operations_prod_resource_lock" {
  name                 = "${local.assistenza_operations_prod_prefix}resourcelock"
...
resource "azurerm_role_assignment" "assistenza_operations_prod_resource_lock_contributor" {
  scope                = data.azurerm_management_group.assistenza_operations_prod.id
  role_definition_name = "PagoPA Resource Lock Contributor"
  principal_id         = azurerm_management_group_policy_assignment.assistenza_operations_prod_resource_lock.identity[0].principal_id
}

resource "azurerm_management_group_policy_assignment" "assistenza_operations_prod_audit_logs" {
  name                 = "${local.assistenza_operations_prod_prefix}auditlogs"
...
resource "azurerm_role_assignment" "assistenza_operations_prod_audit_logs_monitoring_contributor" {
  scope                = data.azurerm_management_group.assistenza_operations_prod.id
...
resource "azurerm_role_assignment" "assistenza_operations_prod_audit_logs_contributor_log_analytics" {
  scope                = data.terraform_remote_state.policy_set.outputs.audit_logs_workspace_id
  role_definition_name = "Log Analytics Contributor"
  principal_id         = azurerm_management_group_policy_assignment.assistenza_operations_prod_audit_logs.identity[0].principal_id
}

resource "azurerm_role_assignment" "assistenza_operations_prod_audit_logs_contributor_storage_westeurope" {
...
resource "azurerm_management_group_policy_assignment" "assistenza_operations_prod_event_hub" {
  name                 = "${local.assistenza_operations_prod_prefix}evt"
...
resource "azurerm_management_group_policy_assignment" "assistenza_operations_prod_kubernetes" {
  name                 = "${local.assistenza_operations_prod_prefix}k8s"
