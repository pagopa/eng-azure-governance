...
resource "azurerm_management_group_policy_assignment" "prod_pci_application_gateway" {
  name                 = "${local.prod_pci_prefix}appgw"
...
resource "azurerm_management_group_policy_assignment" "prod_pci_event_hub" {
  name                 = "${local.prod_pci_prefix}evt"
...
resource "azurerm_management_group_policy_assignment" "prod_pci_kubernetes" {
  name                 = "${local.prod_pci_prefix}k8s"
