...
variable "audit_logs_pci_storage_ids" {
  type = map(string)
  default = {
...
variable "audit_logs_pci_storage_regions" {
  type    = list(string)
...
resource "azurerm_policy_set_definition" "audit_logs_pci" {
  ...
  policy_definition_reference {
    ...
    reference_id         = "${local.audit_logs_pci.reference_ids.keyvault}_workspaceid"
  ...
  policy_definition_reference {
    ...
    reference_id         = "${local.audit_logs_pci.reference_ids.application_gateway}_workspaceid"
    parameter_values = jsonencode({
      logAnalytics = {
        value = var.audit_logs_pci_workspace_id
      }
  ...
  policy_definition_reference {
    ...
    reference_id         = "${local.audit_logs_pci.reference_ids.kubernetes_cluster}_workspaceid"
    parameter_values = jsonencode({
      logAnalytics = {
        value = var.audit_logs_pci_workspace_id
      }
  ...
  policy_definition_reference {
    ...
    reference_id         = "${local.audit_logs_pci.reference_ids.container_registry}_workspaceid"
    parameter_values = jsonencode({
      logAnalytics = {
        value = var.audit_logs_pci_workspace_id
      }
  ...
  policy_definition_reference {
    ...
    reference_id         = "${local.audit_logs_pci.reference_ids.grafana}_workspaceid"
    parameter_values = jsonencode({
      logAnalytics = {
        value = var.audit_logs_pci_workspace_id
      }
  ...
  policy_definition_reference {
    ...
    reference_id         = "${local.audit_logs_pci.reference_ids.api_management}_workspaceid"
    parameter_values = jsonencode({
      logAnalytics = {
        value = var.audit_logs_pci_workspace_id
      }
  ...
  policy_definition_reference {
    ...
    reference_id         = "${local.audit_logs_pci.reference_ids.postgresql_flexible}_workspaceid"
    parameter_values = jsonencode({
      logAnalytics = {
        value = var.audit_logs_pci_workspace_id
      }
  ...
  policy_definition_reference {
    ...
    reference_id         = "${local.audit_logs_pci.reference_ids.postgresql_single_server}_workspaceid"
    parameter_values = jsonencode({
      logAnalytics = {
        value = var.audit_logs_pci_workspace_id
      }
  ...
  policy_definition_reference {
    ...
    reference_id         = "${local.audit_logs_pci.reference_ids.log_analytics}_workspaceid"
    parameter_values = jsonencode({
      logAnalytics = {
        value = var.audit_logs_pci_workspace_id
      }
  ...
  policy_definition_reference {
    ...
    reference_id         = "${local.audit_logs_pci.reference_ids.cosmos_db}_workspaceid"
    parameter_values = jsonencode({
      logAnalytics = {
        value = var.audit_logs_pci_workspace_id
      }
  ...
  policy_definition_reference {
    ...
    reference_id         = "${local.audit_logs_pci.reference_ids.app_service}_workspaceid"
    parameter_values = jsonencode({
      logAnalytics = {
        value = var.audit_logs_pci_workspace_id
      }
  ...
  policy_definition_reference {
    ...
    reference_id         = "${local.audit_logs_pci.reference_ids.event_hub}_workspaceid"
    parameter_values = jsonencode({
      logAnalytics = {
        value = var.audit_logs_pci_workspace_id
      }
  ...
  policy_definition_reference {
    ...
    reference_id         = "${local.audit_logs_pci.reference_ids.public_ip}_workspaceid"
    parameter_values = jsonencode({
      logAnalytics = {
        value = var.audit_logs_pci_workspace_id
      }
  ...
  policy_definition_reference {
    ...
    reference_id         = "${local.audit_logs_pci.reference_ids.virtual_network_gateway}_workspaceid"
    parameter_values = jsonencode({
      logAnalytics = {
        value = var.audit_logs_pci_workspace_id
      }
  ...
  dynamic "policy_definition_reference" {
    for_each = var.audit_logs_pci_storage_regions

    content {
      policy_definition_id = data.terraform_remote_state.policy_audit_logs.outputs.audit_logs_keyvault_storage_account_id
      reference_id         = "${local.audit_logs_pci.reference_ids.keyvault}_storageid_${policy_definition_reference.value}"
      parameter_values = jsonencode({
        storageAccount = {
          value = var.audit_logs_pci_storage_ids[policy_definition_reference.value]
        }
        location = {
  ...
  dynamic "policy_definition_reference" {
    ...
    content {
      ...
      reference_id         = "${local.audit_logs_pci.reference_ids.application_gateway}_storageid_${policy_definition_reference.value}"
      parameter_values = jsonencode({
        storageAccount = {
          value = var.audit_logs_pci_storage_ids[policy_definition_reference.value]
        }
  ...
  dynamic "policy_definition_reference" {
    ...
    content {
      ...
      reference_id         = "${local.audit_logs_pci.reference_ids.container_registry}_storageid_${policy_definition_reference.value}"
      parameter_values = jsonencode({
        storageAccount = {
          value = var.audit_logs_pci_storage_ids[policy_definition_reference.value]
        }
  ...
  dynamic "policy_definition_reference" {
    ...
    content {
      ...
      reference_id         = "${local.audit_logs_pci.reference_ids.kubernetes_cluster}_storageid_${policy_definition_reference.value}"
      parameter_values = jsonencode({
        storageAccount = {
          value = var.audit_logs_pci_storage_ids[policy_definition_reference.value]
        }
  ...
  dynamic "policy_definition_reference" {
    ...
    content {
      ...
      reference_id         = "${local.audit_logs_pci.reference_ids.api_management}_storageid_${policy_definition_reference.value}"
      parameter_values = jsonencode({
        storageAccount = {
          value = var.audit_logs_pci_storage_ids[policy_definition_reference.value]
        }
  ...
  dynamic "policy_definition_reference" {
    ...
    content {
      ...
      reference_id         = "${local.audit_logs_pci.reference_ids.postgresql_flexible}_storageid_${policy_definition_reference.value}"
      parameter_values = jsonencode({
        storageAccount = {
          value = var.audit_logs_pci_storage_ids[policy_definition_reference.value]
        }
  ...
  dynamic "policy_definition_reference" {
    ...
    content {
      ...
      reference_id         = "${local.audit_logs_pci.reference_ids.postgresql_single_server}_storageid_${policy_definition_reference.value}"
      parameter_values = jsonencode({
        storageAccount = {
          value = var.audit_logs_pci_storage_ids[policy_definition_reference.value]
        }
  ...
  dynamic "policy_definition_reference" {
    ...
    content {
      ...
      reference_id         = "${local.audit_logs_pci.reference_ids.log_analytics}_storageid_${policy_definition_reference.value}"
      parameter_values = jsonencode({
        storageAccount = {
          value = var.audit_logs_pci_storage_ids[policy_definition_reference.value]
        }
  ...
  dynamic "policy_definition_reference" {
    ...
    content {
      ...
      reference_id         = "${local.audit_logs_pci.reference_ids.cosmos_db}_storageid_${policy_definition_reference.value}"
      parameter_values = jsonencode({
        storageAccount = {
          value = var.audit_logs_pci_storage_ids[policy_definition_reference.value]
        }
  ...
  dynamic "policy_definition_reference" {
    ...
    content {
      ...
      reference_id         = "${local.audit_logs_pci.reference_ids.app_service}_storageid_${policy_definition_reference.value}"
      parameter_values = jsonencode({
        storageAccount = {
          value = var.audit_logs_pci_storage_ids[policy_definition_reference.value]
        }
  ...
  dynamic "policy_definition_reference" {
    ...
    content {
      ...
      reference_id         = "${local.audit_logs_pci.reference_ids.event_hub}_storageid_${policy_definition_reference.value}"
      parameter_values = jsonencode({
        storageAccount = {
          value = var.audit_logs_pci_storage_ids[policy_definition_reference.value]
        }
  ...
  dynamic "policy_definition_reference" {
    ...
    content {
      ...
      reference_id         = "${local.audit_logs_pci.reference_ids.public_ip}_storageid_${policy_definition_reference.value}"
      parameter_values = jsonencode({
        storageAccount = {
          value = var.audit_logs_pci_storage_ids[policy_definition_reference.value]
        }
  ...
  dynamic "policy_definition_reference" {
    ...
    content {
      ...
      reference_id         = "${local.audit_logs_pci.reference_ids.virtual_network_gateway}_storageid_${policy_definition_reference.value}"
      parameter_values = jsonencode({
        storageAccount = {
          value = var.audit_logs_pci_storage_ids[policy_definition_reference.value]
        }
  ...
  dynamic "policy_definition_reference" {
    ...
    content {
      ...
      reference_id         = "${local.audit_logs_pci.reference_ids.grafana}_storageid_${policy_definition_reference.value}"
      parameter_values = jsonencode({
        storageAccount = {
          value = var.audit_logs_pci_storage_ids[policy_definition_reference.value]
        }
...
output "audit_logs_pci_storage_id_westeurope" {
  value = var.audit_logs_pci_storage_ids.westeurope
}

output "audit_logs_pci_storage_id_northeurope" {
  value = var.audit_logs_pci_storage_ids.northeurope
}

output "audit_logs_pci_storage_id_italynorth" {
  value = var.audit_logs_pci_storage_ids.italynorth
}
