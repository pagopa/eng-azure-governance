output "policy_ids" {
  value = [
    ...
    azurerm_policy_definition.application_gateway_required_zones.id,
  ]
}
...
output "application_gateway_required_zones_id" {
  value = azurerm_policy_definition.application_gateway_required_zones.id
}
